...
function GetFormatedDate(n) {
    var i = new Date(n.replace("-", "index.html").replace("-", "index.html")),
        t = i.getDate(),
...
if (typeof jQuery == "undefined") throw new Error("Bootstrap's JavaScript requires jQuery"); + function(n) {
    ...
    var t = function(n, t) {
        ...
        i;
    if (!n.fn.tooltip) throw new Error("Popover%20requires%20tooltip.html");
    t.VERSION = "3.3.5";
...
var intRegex = /^\d/,
    ...
    totalMultiCity = 0,
    tabindexx = 7,
    urlis = window.location.pathname.replace("index.html", ""),
...
$(document).ready(function() {
    ...
    n = window.location.pathname.replace("index.html", "");
    ...
    n.toLowerCase().indexOf("flights/index.html") == 0 && ($("#li-home").removeClass("active"), $("#li-flights").addClass("active"), $("#li-vacations").removeClass("active"), $("#li-contact-us").removeClass("active"), $("#li-about-us").removeClass("active"), $("#li-more").removeClass("active"), $("#li-supports").removeClass("active"));
    n.toLowerCase().indexOf("offers/index.html") == 0 && ($("#li-home").removeClass("active"), $("#li-flights").removeClass("active"), $("#li-vacations").removeClass("active"), $("#li-contact-us").removeClass("active"), $("#li-about-us").removeClass("active"), $("#li-more").addClass("active"), $("#li-supports").removeClass("active"));
    n.toLowerCase().indexOf("vacations/index.html") == 0 && ($("#li-home").removeClass("active"), $("#li-flights").removeClass("active"), $("#li-vacations").addClass("active"), $("#li-contact-us").removeClass("active"), $("#li-about-us").removeClass("active"), $("#li-more").removeClass("active"), $("#li-supports").removeClass("active"))
});
...
$("div.srch-area").click(function() {
    var n = "",
        ...
        i = "",
        r = "";
    if (n = JSON.parse(localStorage.getItem(this.id)), IsSearchTimeExpire(n.DDate.replace("-", "index.html").replace("-", "index.html"))) {
        var u = new Date,
            f = u.getDate() + 7,
            e = u.getDate() + 15,
