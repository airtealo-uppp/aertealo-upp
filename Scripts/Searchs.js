...
function AddNewDivforMultiCitys(add_cntdv) {
    ...
    if (parseInt(cntAddDiv) < 5) {
        $("#addmulticitys").before('<div class="clr"></div><div class="multicity_news" id="multicitys_' + cntAddDiv + '"> ' +
            ...
            '<label style="border-bottom:1px solid #fff">City Name</label> </div> <div class="form-group" style="margin-right:25px;width:40px"><img src="dev1/assets/images/air.png" width="40px"></div>' +
