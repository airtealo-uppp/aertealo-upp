$(document).ready(function () {
   ...
   // initSession();
    ...
    var urlis = window.location.pathname.replace('index.html', '');
    //debugger;
    if (urlis == 'flights') {
    ...
    if (urlis.toLowerCase().indexOf("flights/index.html") == 0) {
        $("#li-home").removeClass('active');
        $("#li-flights").addClass('active');
        $("#li-hotels").removeClass('active');
        $("#li-cars").removeClass('active');
    ...
    if (urlis.toLowerCase().indexOf("hotels/index.html") == 0) {
        $("#li-home").removeClass('active');
        $("#li-flights").removeClass('active');
        $("#li-hotels").addClass('active');
        $("#li-cars").removeClass('active');
    ...
    if (urlis.toLowerCase().indexOf("cars/index.html") == 0) {
        $("#li-home").removeClass('active');
        $("#li-flights").removeClass('active');
        $("#li-hotels").removeClass('active');
        $("#li-cars").addClass('active');
    ...
    if (urlis.toLowerCase().indexOf("offers/index.html") == 0) {
        $("#li-home").removeClass('active');
        $("#li-flights").removeClass('active');
        $("#li-hotels").removeClass('active');
        $("#li-cars").removeClass('active');
    ...
    if (urlis.toLowerCase().indexOf("vacations/index.html") == 0) {
        $("#li-home").removeClass('active');
        $("#li-flights").removeClass('active');
        $("#li-hotels").removeClass('active');
        $("#li-cars").removeClass('active');
    ...
    if (urlis.toLowerCase().indexOf("business-class-flights/index.html") == 0) {
        $("#li-home").removeClass('active');
        $("#li-flights").removeClass('active');
        $("#li-hotels").removeClass('active');
        $("#li-cars").removeClass('active');
    ...
    if (urlis.toLowerCase().indexOf("last-minute-travel/index.html") == 0) {
        $("#li-home").removeClass('active');
        $("#li-flights").removeClass('active');
        $("#li-hotels").removeClass('active');
        $("#li-cars").removeClass('active');
